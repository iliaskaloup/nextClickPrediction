...
#training_data=training_data.iloc[0:397077,:]#397077 :85% tou full dataset wste to upoloipo 15 na einai agnwsto
#training_data=training_data.iloc[0:22077,:]
...
path='PharmItemsNadam1epoch.h5'
model.save(path)
#model = load_model('PharmItemsNadam.h5')
from contextlib import redirect_stdout
with open('PharmItemsNadam.txt', 'w') as f:
